...
public class AdminUserServiceImpl implements AdminUserService {
     ...
     */
    @Override
    public int updPassword(AdminUser user, String password) {
        logger.info("updPassword()方法调用");
        return adminUserDao.updateUserPassword(user.getId(), MD5Util.MD5Encode(password, "UTF-8"));
    }
}
